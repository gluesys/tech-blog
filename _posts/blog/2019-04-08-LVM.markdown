...
![Alt text](/assets/PV_layout.png){: witdh="350"}
...
![Alt text](/assets/volume_arc.png){: witdh="350"}
...
![Alt text](/assets/stripe_lv.png){: witdh="350"}
...
![Alt text](/assets/mirror_lv_extent.png){: witdh="700"}

Mirror 논리 볼륨은 데이터의 안정성을 위하여 데이터를 다른 장치에 복사본을 저장합니다. 만약 한쪽의 장치에 장애가 발생할 경우 논리 볼륨은 다른 한쪽으로 선형 볼륨이 되어 액세스가 가능합니다. 

#### thin volume

![Alt text](/assets/thin_compare_linear.png){: witdh="350"}
![Alt text](/assets/thin_compare_thin.png){: witdh="700"}
